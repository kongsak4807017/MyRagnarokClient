...
public final class ColorUtils {
    ...
    public static int HSLToColor(float[] fArr) {
        ...
        float f2 = fArr[1];
        float f3 = fArr[2];
        float fAbs = f2 * (1.0f - Math.abs((2.0f * f3) - 1.0f));
    ...
    public static void RGBToXYZ(int i, int i2, int i3, double[] dArr) {
        ...
        double d = i / 255.0d;
        double dPow = d < 0.04045d ? d / 12.92d : Math.pow((0.055d + d) / 1.055d, 2.4d);
        double d2 = i2 / 255.0d;
        double dPow2 = d2 < 0.04045d ? d2 / 12.92d : Math.pow((0.055d + d2) / 1.055d, 2.4d);
        double d3 = i3 / 255.0d;
        double dPow3 = d3 < 0.04045d ? d3 / 12.92d : Math.pow((0.055d + d3) / 1.055d, 2.4d);
        ...
        dArr[2] = ((0.0193d * dPow) + (0.1192d * dPow2) + (0.9505d * dPow3)) * XYZ_WHITE_REFERENCE_Y;
    }
    ...
    public static void LABToXYZ(double d, double d2, double d3, double[] dArr) {
        ...
        double d8 = dPow3 > XYZ_EPSILON ? dPow3 : ((116.0d * d6) - 16.0d) / XYZ_KAPPA;
        dArr[0] = XYZ_WHITE_REFERENCE_X * d7;
        dArr[1] = XYZ_WHITE_REFERENCE_Y * dPow2;
