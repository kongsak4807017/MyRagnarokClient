...
public class SparseArrayCompat<E> implements Cloneable {
    ...
    public void put(int i, E e) {
        ...
        if (this.mSize - iBinarySearch2 != 0) {
            ...
            System.arraycopy(iArr2, iBinarySearch2, iArr2, iBinarySearch2 + 1, this.mSize - iBinarySearch2);
            Object[] objArr2 = this.mValues;
            System.arraycopy(objArr2, iBinarySearch2, objArr2, iBinarySearch2 + 1, this.mSize - iBinarySearch2);
        }
        this.mKeys[iBinarySearch2] = i;
        this.mValues[iBinarySearch2] = e;
        this.mSize++;
