                ...
                case 0:
                    if (this.mDoubleTapListener != null) {
                        ...
                        if (this.mCurrentDownEvent != null && this.mPreviousUpEvent != null && zHasMessages && isConsideredDoubleTap(this.mCurrentDownEvent, this.mPreviousUpEvent, motionEvent)) {
                            ...
                            zOnFling = this.mDoubleTapListener.onDoubleTap(this.mCurrentDownEvent) | false | this.mDoubleTapListener.onDoubleTapEvent(motionEvent);
                        } else {
                    ...
                    if (!this.mInLongPress) {
                        ...
                        if (this.mIsDoubleTapping) {
                            ...
                            if (i5 > this.mTouchSlopSquare) {
                                zOnFling = this.mListener.onScroll(this.mCurrentDownEvent, motionEvent, f3, f4);
                                this.mLastFocusX = f;
                                this.mLastFocusY = f2;
                            ...
                            boolean zOnScroll = this.mListener.onScroll(this.mCurrentDownEvent, motionEvent, f3, f4);
                            this.mLastFocusX = f;
                            this.mLastFocusY = f2;
                            break;
                        }
