...
public final class KeyEventCompat {
    ...
    static class BaseKeyEventVersionImpl implements KeyEventVersionImpl {
        ...
        public int normalizeMetaState(int i) {
            ...
            return i & TelnetCommand.EC;
        }

        @Override // android.support.v4.view.KeyEventCompat.KeyEventVersionImpl
        public boolean metaStateHasModifiers(int i, int i2) {
            return metaStateFilterDirectionalModifiers(metaStateFilterDirectionalModifiers(normalizeMetaState(i) & TelnetCommand.EC, i2, 1, 64, 128), i2, 2, 16, 32) == i2;
        }
