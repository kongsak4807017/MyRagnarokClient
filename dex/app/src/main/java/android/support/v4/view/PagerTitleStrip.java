...
public class PagerTitleStrip extends ViewGroup implements ViewPager.Decor {
    ...
    void updateText(int i, PagerAdapter pagerAdapter) {
        ...
        CharSequence pageTitle2 = null;
        if (i + 1 < count && pagerAdapter != null) {
            pageTitle2 = pagerAdapter.getPageTitle(i + 1);
        }
        this.mNextText.setText(pageTitle2);
    ...
    void updateTextPositions(int i, float f, boolean z) {
        ...
        int iMax2 = Math.max(Math.max(i10 + this.mPrevText.getMeasuredHeight(), i11 + this.mCurrText.getMeasuredHeight()), i12 + this.mNextText.getMeasuredHeight());
