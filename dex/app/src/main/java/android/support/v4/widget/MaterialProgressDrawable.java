...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private int evaluateColorChange(float f, int i, int i2) {
        ...
        return ((((int) ((((iIntValue2 >> 24) & 255) - i3) * f)) + i3) << 24) | ((((int) ((((iIntValue2 >> 16) & 255) - i4) * f)) + i4) << 16) | ((((int) ((((iIntValue2 >> 8) & 255) - i5) * f)) + i5) << 8) | (((int) (((iIntValue2 & 255) - i6) * f)) + i6);
    }
    ...
    static class Ring {
        ...
        public void setInsets(int i, int i2) {
            ...
            if (this.mRingCenterRadius <= 0.0d || fMin < 0.0f) {
                fCeil = FloatMath.ceil(this.mStrokeWidth / 2.0f);
            } else {
                fCeil = (float) ((fMin / 2.0f) - this.mRingCenterRadius);
            }
            this.mStrokeInset = fCeil;
        }
