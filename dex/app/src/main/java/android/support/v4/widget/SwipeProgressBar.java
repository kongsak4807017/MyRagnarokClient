    ...
    final void draw(Canvas canvas) {
        ...
        if (this.mRunning || this.mFinishTime > 0) {
            ...
            if (!this.mRunning) {
                ...
                float interpolation = i * INTERPOLATOR.getInterpolation((((jCurrentAnimationTimeMillis - this.mFinishTime) % 1000) / 10.0f) / 100.0f);
                this.mClipRect.set(i - interpolation, 0.0f, i + interpolation, iHeight);
