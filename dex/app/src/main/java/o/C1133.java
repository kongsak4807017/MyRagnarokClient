...
/* renamed from: o.쿗, reason: contains not printable characters */
/* loaded from: C:\Users\User\Downloads\PREM space\dex2jar-2.0\andro259\classes.dex */
final class C1133 extends ub {

    /* renamed from: 鷭, reason: contains not printable characters */
    private static /* synthetic */ int[] f8967;

    C1133() {
    }

    /* renamed from: ˮ͈, reason: contains not printable characters */
    private static /* synthetic */ int[] m1639() {
        int[] iArr = f8967;
        if (iArr != null) {
            return iArr;
        }
    ...
    public final void mo1042(ByteBuffer byteBuffer, int i, boolean z, int i2) {
        this.f5008 = (short) 2763;
        short s = byteBuffer.getShort();
        long j = byteBuffer.getLong();
        if (z) {
        }
        if (s < 0 || s >= EnumC0505.valuesCustom().length) {
            nz.m907("unknown status info " + ((int) s));
            return;
        }
        switch (m1639()[EnumC0505.valuesCustom()[s].ordinal()]) {
            case 2:
                C0358.f6664.f2004.f8591 = j;
                C0358.f6674.f42.f1781.m477(C0358.f6664.f2004);
                break;
            case 3:
                C0358.f6664.f2004.f8630 = j;
                C0358.f6674.f42.f1781.m477(C0358.f6664.f2004);
                break;
            case 23:
                C0358.f6664.f2004.f8619 = j;
                C0358.f6674.f42.f1781.m476(C0358.f6664.f2004);
                break;
            case 24:
                C0358.f6664.f2004.f8633 = j;
                C0358.f6674.f42.f1781.m476(C0358.f6664.f2004);
                break;
            default:
                nz.m907("unexpected status info in long packet: " + ((int) s));
                break;
        }
    }
}
