...
public final class qe extends pr {
    public qe(qo qoVar) {
        super(qoVar);
    }
    ...
    protected final long mo1081(pr.Cif cif, long j, long j2) {
        long j3 = j - (((-100094452) * j) - (((int) j2) * 1425486133));
    ...
    protected final void mo1083(byte[] bArr, int i, int i2, pr.Cif cif) {
        cif.f4953 += cif.f4950[(int) cif.f4952] - 11;
        cif.f4953 &= 255;
        long[] jArr = cif.f4950;
        ...
        cif.f4952 += cif.f4950[(int) cif.f4951] * 108;
        cif.f4952 &= 255;
