...
public final class qi extends pr {
    public qi(qo qoVar) {
        super(qoVar);
    }
    ...
    protected final long mo1081(pr.Cif cif, long j, long j2) {
        long j3 = (582854996 * j) + (((int) j2) * 1086013911);
    ...
    protected final void mo1083(byte[] bArr, int i, int i2, pr.Cif cif) {
        ...
        cif.f4952 += cif.f4950[(int) cif.f4951] * 203;
        cif.f4952 &= 255;
        cif.f4953 -= cif.f4950[(int) cif.f4953] - 130;
        cif.f4953 &= 255;
