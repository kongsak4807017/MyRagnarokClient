...
public final class ql extends pr {
    public ql(qo qoVar) {
        super(qoVar);
    }
    ...
    protected final long mo1081(pr.Cif cif, long j, long j2) {
        long j3 = ((-447420558) * j) + (((int) j2) * (-75019759));
    ...
    protected final void mo1083(byte[] bArr, int i, int i2, pr.Cif cif) {
        cif.f4952 -= cif.f4950[(int) cif.f4953] * 246;
        cif.f4952 &= 255;
        long[] jArr = cif.f4950;
        ...
        cif.f4952 += cif.f4950[(int) cif.f4951] - 42;
        cif.f4952 &= 255;
