...
public final class qt extends pr {
    public qt(qo qoVar) {
        super(qoVar);
    }
    ...
    protected final long mo1081(pr.Cif cif, long j, long j2) {
        long j3 = (87703412 * j) + (((int) j2) * 917928246);
        cif.f4950[(int) j2] = (j3 >> 7) & 255;
        return j3;
    }
    ...
    protected final void mo1083(byte[] bArr, int i, int i2, pr.Cif cif) {
        cif.f4953 += cif.f4950[(int) cif.f4952] + 215;
        cif.f4953 &= 255;
        long[] jArr = cif.f4950;
        ...
        cif.f4952 -= cif.f4950[(int) cif.f4951] * 13;
        cif.f4952 &= 255;
