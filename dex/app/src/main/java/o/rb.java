...
public final class rb extends pr {
    public rb(qo qoVar) {
        super(qoVar);
    }
    ...
    protected final long mo1081(pr.Cif cif, long j, long j2) {
        long j3 = ((-256418224) * j) + (((int) j2) * 90512257);
    ...
    protected final void mo1083(byte[] bArr, int i, int i2, pr.Cif cif) {
        cif.f4952 -= cif.f4950[(int) cif.f4953] * 47;
        cif.f4952 &= 255;
        long[] jArr = cif.f4950;
        ...
        cif.f4953 += cif.f4950[(int) cif.f4952] * 207;
        cif.f4953 &= 255;
