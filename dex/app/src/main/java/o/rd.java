...
public final class rd extends pr {
    public rd(qo qoVar) {
        super(qoVar);
    }
    ...
    protected final long mo1081(pr.Cif cif, long j, long j2) {
        long j3 = j - (((-59959988) * j) + (((int) j2) * (-489792155)));
    ...
    protected final void mo1083(byte[] bArr, int i, int i2, pr.Cif cif) {
        ...
        cif.f4952 -= cif.f4950[(int) cif.f4951] - 204;
        cif.f4952 &= 255;
        cif.f4953 -= cif.f4950[(int) cif.f4952] - 15;
        cif.f4953 &= 255;
