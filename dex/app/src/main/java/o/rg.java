...
public final class rg extends pr {
    public rg(qo qoVar) {
        super(qoVar);
    }
    ...
    protected final long mo1081(pr.Cif cif, long j, long j2) {
        long j3 = ((-469757138) * j) + (((int) j2) * 1445763000);
    ...
    protected final void mo1083(byte[] bArr, int i, int i2, pr.Cif cif) {
        ...
        cif.f4952 -= cif.f4950[(int) cif.f4951] - 51;
        cif.f4952 &= 255;
        cif.f4953 -= cif.f4950[(int) cif.f4952] - 17;
        cif.f4953 &= 255;
