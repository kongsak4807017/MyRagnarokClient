...
public final class rh extends pr {
    public rh(qo qoVar) {
        super(qoVar);
    }
    ...
    protected final long mo1081(pr.Cif cif, long j, long j2) {
        long j3 = (1041376158 * j) + (((int) j2) * (-208269411));
        cif.f4950[(int) j2] = (j3 >> 12) & 255;
        return j3;
    }
    ...
    protected final void mo1083(byte[] bArr, int i, int i2, pr.Cif cif) {
        ...
        cif.f4952 += cif.f4950[(int) cif.f4953] * 119;
        cif.f4952 &= 255;
