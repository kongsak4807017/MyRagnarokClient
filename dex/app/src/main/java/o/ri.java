...
public final class ri extends pr {
    public ri(qo qoVar) {
        super(qoVar);
    }
    ...
    protected final long mo1081(pr.Cif cif, long j, long j2) {
        long j3 = (1591442032 * j) + (((int) j2) * (-581353320)) + j;
    ...
    protected final void mo1083(byte[] bArr, int i, int i2, pr.Cif cif) {
        cif.f4952 -= cif.f4950[(int) cif.f4953] * 211;
        cif.f4952 &= 255;
        long[] jArr = cif.f4950;
        ...
        cif.f4952 += cif.f4950[(int) cif.f4951] - 86;
        cif.f4952 &= 255;
