...
public final class rl extends pr {
    public rl(qo qoVar) {
        super(qoVar);
    }
    ...
    protected final long mo1081(pr.Cif cif, long j, long j2) {
        long j3 = ((-2036856548) * j) + (((int) j2) * 554697265) + j;
    ...
    protected final void mo1083(byte[] bArr, int i, int i2, pr.Cif cif) {
        cif.f4953 += cif.f4950[(int) cif.f4952] * 109;
        cif.f4953 &= 255;
        long[] jArr = cif.f4950;
        ...
        cif.f4952 -= cif.f4950[(int) cif.f4951] - 229;
        cif.f4952 &= 255;
