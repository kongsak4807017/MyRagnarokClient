...
public final class rn extends pr {
    public rn(qo qoVar) {
        super(qoVar);
    }
    ...
    protected final long mo1081(pr.Cif cif, long j, long j2) {
        long j3 = ((-858128694) * j) - (((int) j2) * (-571772507));
    ...
    protected final void mo1083(byte[] bArr, int i, int i2, pr.Cif cif) {
        ...
        cif.f4952 -= cif.f4950[(int) cif.f4953] + 147;
        cif.f4952 &= 255;
        cif.f4953 -= cif.f4950[(int) cif.f4952] + 154;
        cif.f4953 &= 255;
