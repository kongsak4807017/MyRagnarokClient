...
public final class ro extends pr {
    public ro(qo qoVar) {
        super(qoVar);
    }
    ...
    protected final long mo1081(pr.Cif cif, long j, long j2) {
        long j3 = (((-95765428) * j) - (((int) j2) * 1743752931)) + j;
    ...
    protected final void mo1083(byte[] bArr, int i, int i2, pr.Cif cif) {
        ...
        cif.f4952 += cif.f4950[(int) cif.f4953] * 241;
        cif.f4952 &= 255;
        cif.f4953 -= cif.f4950[(int) cif.f4952] * 190;
        cif.f4953 &= 255;
