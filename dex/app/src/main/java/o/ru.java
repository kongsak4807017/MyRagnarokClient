...
public final class ru extends pr {
    public ru(qo qoVar) {
        super(qoVar);
    }
    ...
    protected final long mo1081(pr.Cif cif, long j, long j2) {
        long j3 = j - ((111457810 * j) + (((int) j2) * 1172624774));
    ...
    protected final void mo1083(byte[] bArr, int i, int i2, pr.Cif cif) {
        ...
        cif.f4953 += cif.f4950[(int) cif.f4952] + 171;
        cif.f4953 &= 255;
        cif.f4952 -= cif.f4950[(int) cif.f4951] * 47;
        cif.f4952 &= 255;
