...
public final class rv extends pr {
    public rv(qo qoVar) {
        super(qoVar);
    }
    ...
    protected final long mo1081(pr.Cif cif, long j, long j2) {
        long j3 = ((-1899040736) * j) + (((int) j2) * (-781477595));
    ...
    protected final void mo1083(byte[] bArr, int i, int i2, pr.Cif cif) {
        ...
        cif.f4952 += cif.f4950[(int) cif.f4953] * 108;
        cif.f4952 &= 255;
        cif.f4953 += cif.f4950[(int) cif.f4952] * 78;
        cif.f4953 &= 255;
