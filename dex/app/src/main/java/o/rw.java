...
public final class rw extends pr {
    public rw(qo qoVar) {
        super(qoVar);
    }
    ...
    protected final long mo1081(pr.Cif cif, long j, long j2) {
        long j3 = (113079424 * j) - (((int) j2) * 1339871049);
        cif.f4950[(int) j2] = (j3 >> 10) & 255;
        return j3;
    }
    ...
    protected final void mo1083(byte[] bArr, int i, int i2, pr.Cif cif) {
        cif.f4953 += cif.f4950[(int) cif.f4951] * 19;
        cif.f4953 &= 255;
        long[] jArr = cif.f4950;
        int i3 = (int) cif.f4953;
        jArr[i3] = jArr[i3] ^ cif.f4952;
        long[] jArr2 = cif.f4950;
        int i4 = (int) cif.f4953;
        jArr2[i4] = jArr2[i4] & 255;
        cif.f4952 -= cif.f4950[(int) cif.f4953] * 201;
        cif.f4952 &= 255;
        long[] jArr3 = cif.f4950;
        int i5 = (int) cif.f4951;
        jArr3[i5] = jArr3[i5] ^ cif.f4953;
        long[] jArr4 = cif.f4950;
        int i6 = (int) cif.f4951;
        jArr4[i6] = jArr4[i6] & 255;
        cif.f4953 += cif.f4951 * 175;
        cif.f4953 &= 255;
