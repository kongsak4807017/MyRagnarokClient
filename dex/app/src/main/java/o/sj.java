...
public final class sj extends pr {
    public sj(qo qoVar) {
        super(qoVar);
    }
    ...
    protected final long mo1081(pr.Cif cif, long j, long j2) {
        long j3 = (((-1564323376) * j) - (((int) j2) * (-624992647))) + j;
    ...
    protected final void mo1083(byte[] bArr, int i, int i2, pr.Cif cif) {
        cif.f4952 -= cif.f4950[(int) cif.f4953] * 171;
        cif.f4952 &= 255;
        long[] jArr = cif.f4950;
        int i3 = (int) cif.f4952;
        jArr[i3] = jArr[i3] ^ cif.f4953;
        long[] jArr2 = cif.f4950;
        int i4 = (int) cif.f4952;
        jArr2[i4] = jArr2[i4] & 255;
        cif.f4953 += cif.f4950[(int) cif.f4952] * 115;
        cif.f4953 &= 255;
