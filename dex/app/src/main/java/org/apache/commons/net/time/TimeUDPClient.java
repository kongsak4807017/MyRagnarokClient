...
public final class TimeUDPClient extends DatagramSocketClient {
    ...
    public final long getTime(InetAddress inetAddress, int i) throws IOException {
        ...
        return (((this.__timeData[0] & 255) << 24) & 4294967295L) | 0 | (((this.__timeData[1] & 255) << 16) & 4294967295L) | (((this.__timeData[2] & 255) << 8) & 4294967295L) | (this.__timeData[3] & 255 & 4294967295L);
    }
