...
public abstract class AbstractVerifier implements X509HostnameVerifier {
    ...
    public final void verify(String str, X509Certificate x509Certificate) throws SSLException, CertificateParsingException {
        ...
        verify(str, strExtractCN != null ? new String[]{strExtractCN} : null, !arrayList.isEmpty() ? (String[]) arrayList.toArray(new String[arrayList.size()]) : null);
    }

    public final void verify(String str, String[] strArr, String[] strArr2, boolean z) throws SSLException {
        String str2 = (strArr == null || strArr.length <= 0) ? null : strArr[0];
        List<String> listAsList = (strArr2 == null || strArr2.length <= 0) ? null : Arrays.asList(strArr2);
        ...
        if (listAsList != null) {
            for (String str3 : listAsList) {
                if (matchIdentity(strNormaliseAddress, InetAddressUtils.isIPv6Address(str3) ? DefaultHostnameVerifier.normaliseAddress(str3) : str3, z)) {
                    return;
                }
            }
