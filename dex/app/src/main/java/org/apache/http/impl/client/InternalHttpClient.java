...
class InternalHttpClient extends CloseableHttpClient implements Configurable {
    ...
    protected CloseableHttpResponse doExecute(HttpHost httpHost, HttpRequest httpRequest, HttpContext httpContext) throws ClientProtocolException {
        ...
        try {
            ...
            HttpClientContext httpClientContextAdapt = HttpClientContext.adapt(httpContext != null ? httpContext : new BasicHttpContext());
            ...
            if (requestConfig != null) {
                httpClientContextAdapt.setRequestConfig(requestConfig);
            }
