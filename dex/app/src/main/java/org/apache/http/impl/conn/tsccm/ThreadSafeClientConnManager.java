        ...
        synchronized (basicPooledConnAdapter) {
            ...
            try {
                ...
                try {
                    ...
                    boolean zIsMarkedReusable = basicPooledConnAdapter.isMarkedReusable();
                ...
                basicPooledConnAdapter.detach();
                this.pool.freeEntry(basicPoolEntry, zIsMarkedReusable3, j, timeUnit);
                throw th;
            }
        }
    }
